...
export class FooterComponent {
    ...
    render(width) {
        // Grok-build layout keeps model/thinking info in the prompt border.
        // Do not render the default bottom stats footer; keep extension statuses only.
        const grokExtensionStatuses = this.footerData.getExtensionStatuses();
        if (grokExtensionStatuses.size > 0) {
            const sortedStatuses = Array.from(grokExtensionStatuses.entries())
